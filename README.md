...
- **Production URL**: [https://pf-rho-six.vercel.app](https://pf-rho-six.vercel.app)
- **Secondary Domain**: [https://portfolio-theta-eight-dvp18eym0v.vercel.app](https://portfolio-theta-eight-dvp18eym0v.vercel.app)
- **GitHub Repository**: [https://github.com/ananya21-ghosh/Portfolio](https://github.com/ananya21-ghosh/Portfolio)
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/ananya21-ghosh/Portfolio.git
   cd Portfolio
   ```

2. **Serve locally using Node / Serve**:
   ```bash
   npx serve -l 9090 .
   ```
